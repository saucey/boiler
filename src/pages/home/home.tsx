...
const HomeWrapper = glamorous.div({
  label: "HomeWrapper",
  display: "flex",
        ...
        <Grid item xs={12} md={6}>
          <Paper className={classes.paper}>
            <h1 className={classes.heading}>
              Existing Student and Staff Permit Holders
            </h1>
            <div className="gordon-intro">
              <p>
                Have you already signed up and purchased a Student/Staff Car
                parking Permit for the new 2019/2020 academic year?
              </p>
              <p>
                If yes, welcome to the RGU Cark Parking Permit Holders Portal.
                This portal will enable you to log in and 'Manage Your Permit'
                for the 2019/2020 academic year
              </p>
              <p>
                Both RGU Students and Staff (who are the primary user registered
                - including car share) will be able to manage their permits
              ...
              <span>
                <Link
                  to={{
                    pathname: "/purchase/signIn",
                    state: { purchase: new Purchase(null, null), nextUrl: "/" }
                  }}>
                  LOG IN
                </Link>
              </span>
        ...
        <Grid item xs={12} md={6}>
          <Paper className={classes.paper}>
            <h1 className={classes.heading2}>
              Non-Paid Student and Staff Permit Holders
            </h1>
            <div className="gordon-intro">
              <p>
                Have you been successful in your application for a Student/Staff
                Car parking Permit for the new 2019/2020 academic year?
              </p>
              <p>
                If yes, welcome to the RGU Cark Parking Permit Holders Portal.
              ...
              <ol>
                ...
                <li>
                  Once a new password has been set-up, 'log in' and 'Manage Your
                  Permit' for the 2019/2020 academic year
                </li>
              </ol>
              <p>
                In order to pay for your permit, please select 'Pay For Permit'
                to continue with the payment process.
              </p>
              <span>
                <Link
                  to={{
                    pathname: "/management/create-password",
                    state: { purchase: new Purchase(null, null), nextUrl: "/" }
                  }}>
                  PAY FOR PERMIT
                </Link>
        ...
        <Grid item xs={12} md={12}>
          <Paper className={classes.paperContact}>
            ...
            <p className={classes.contactText}>
              If you have any problems or questions relating to the portal,
              please contact 'RGU@eurocarparks.com' in the first instance
            </p>
          </Paper>
        </Grid>
      </Grid>
...
export class Home extends React.Component<IHomeProps, IHomeState> {
  ...
  componentDidUpdate(prevProps: IHomeProps, prevState) {
    if (
      ...
      const preProduct = {
        startDate: this.props.preProduct.startDate,
        VRMs: vrms,
        spaces: this.props.preProduct.spaces,
        productId: this.props.product.permitProductId,
        productName: this.props.product.permitProductName,
        maxVRMs: this.props.product.maxVRMs,
        activeVRMs: 1,
        frequency: createProductFrequenciesFromProductPrices(
          this.props.product.prices.find(x => x.isCurrent)
        )[0]
      };
      this.props.history.push({
        pathname: "/purchase/summary",
        state: {
          purchase: new Purchase(this.props.user.customer, null, preProduct)
        }
      });
    }
    ...
    return (
      <Measure
        ...
        onResize={contentRect => {
          /*console.log(contentRect.bounds, 'the bounds') */
        }}>
        {({ measureRef }) => (
          <PurchaseFooter
            preProduct={this.props.preProduct}
            innerREf={measureRef}
            step={0}
      ...
      case 1:
        return {
          purchase: new Purchase(
            this.props.user.customer !== null ? this.props.user.customer : null,
            this.props.towns[0]
          )
        };
      default:
  ...
  render() {
    ...
    return (
      <AppContainer
        ...
        isPurchase={false}
        renderFooter={() => {
          return true && this.thePurchaseFooter();
        }}
        render={() => {
          ...
          return (
            <HomeWrapper>
              ...
              {this.props.client.clientId !== 307 && (
                <Link
                  to={{
                    pathname:
                      Object.keys(this.props.towns).length === 1
                        ? "/purchase/product"
                        : "/purchase/intro",
                    state: this.stateToPath(this.props.towns)
                  }}
                  style={{ margin: "0 auto" }}>
              ...
              {this.props.user.userId === 0 &&
                this.props.client.clientId === 307 && <CustomGrid />}
              {/* <VerticalSpacer15 /> */}
              {this.props.user.userId === 0 && (
                <React.Fragment>
              ...
              {this.props.user.userId !== 0 && (
                <React.Fragment>
                  <div className="home-action-links">
                    <Link
                      to={{ pathname: "/management/permits" }}
                      style={{ margin: "0 auto" }}>
